    ...
    <main className="mx-auto flex max-w-3xl flex-col gap-6 px-4 py-10 sm:px-6">
      <header className="flex flex-col gap-1">
        <div className="flex items-center justify-between gap-3">
          <h1 className="text-2xl font-semibold text-[var(--text)]">A receber</h1>
          <Link href="/lancamentos" className="text-sm text-[var(--accent)]">Extrato</Link>
        </div>
        <p className="text-sm text-[var(--muted)]">
          O que você tem a receber (freela, reembolso, etc.): quando, pra qual conta e com qual recorrência.
      ...
      {receitas.length === 0 ? (
        <Card><p className="text-sm text-[var(--muted)]">Nada agendado ainda. Agende o que você tem a receber (ex.: freela, um reembolso).</p></Card>
      ) : (
        <Card>

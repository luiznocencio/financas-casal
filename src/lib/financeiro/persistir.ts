...
export async function persistirLancamento(
  ...
  ctx: { householdId: string; criadoPor: string; grupoImportacao?: string | null; recorrenteId?: string | null; contaPagarId?: string | null; receitaAgendadaId?: string | null },
  l: NovoLancamento,
  ...
  const registros = mapearRegistros(linhas, invoiceIdPorComp, {
    ...
    contaPagarId: ctx.contaPagarId ?? null, receitaAgendadaId: ctx.receitaAgendadaId ?? null,
  });

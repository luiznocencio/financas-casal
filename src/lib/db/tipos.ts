...
export type Card = { id: string; household_id: string; nome: string; bandeira: string | null; limite_centavos: number; dia_fechamento: number; dia_vencimento: number; dias_fechamento_antes: number | null; titular: string | null; principal: boolean };
export type Category = { id: string; household_id: string; nome: string; tipo: "despesa" | "receita"; cor: string; icone: string | null; parent_id: string | null };
